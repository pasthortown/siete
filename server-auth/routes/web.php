...
$router->group(['middleware' => ['auth']], function () use ($router) {
   ...
   $router->post('/user/register_user_coadminruc', ['uses' => 'UserController@register_user_coadminruc']);
   $router->post('/user/register_user_establishment', ['uses' => 'UserController@register_user_establishment']);
   $router->put('/user/update_user_coadminruc', ['uses' => 'UserController@update_user_coadminruc']);
