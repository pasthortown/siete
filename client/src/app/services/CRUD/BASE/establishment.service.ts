...
export class EstablishmentService {
   ...
   url = environment.api_base + 'establishment/';
   ...
   getByRuc(number: String, size: number, page: number): Promise<any> {
      return this.http.get(this.url + 'get_by_ruc?ruc=' + number.toString() + '&size=' + size.toString() + '&page=' + page.toString(), this.options).toPromise()
      .then( r => {
         return r.json();
      }).catch( error => { this.handledError(error.json()); });
   }

   post(establishment: Establishment): Promise<any> {
      return this.http.post(this.url, JSON.stringify(establishment), this.options).toPromise()
      .then( r => {
         return r.json();
      }).catch( error => { this.handledError(error.json()); });
   }

   register_establishment_data(establishment: Establishment): Promise<any> {
      return this.http.post(this.url + 'register_establishment_data', JSON.stringify(establishment), this.options).toPromise()
      .then( r => {
         return r.json();
      }).catch( error => { this.handledError(error.json()); });
   }

   update_establishment_data(establishment: Establishment): Promise<any> {
      return this.http.put(this.url + 'update_establishment_data', JSON.stringify(establishment), this.options).toPromise()
      .then( r => {
         return r.json();
      }).catch( error => { this.handledError(error.json()); });
   }

   put(establishment: Establishment): Promise<any> {
      return this.http.put(this.url, JSON.stringify(establishment), this.options).toPromise()
      .then( r => {
         return r.json();
      }).catch( error => { this.handledError(error.json()); });
   }
