...
<p>La solicitud de {{ $information['tramite'] }} ha sido {{ $information['estadoTramite'] }}, en los próximos días, le informaremos el valor de pago de la contribución del uno por mil.</p>
