...
<p>Su solicitud de {{ $information['tramite'] }} se encuentra en <strong>{{ $information['prorroga'] }}</strong>. Para mayor información contáctese con la Coordinación Zonal.</p><br/>
